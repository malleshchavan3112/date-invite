        ...
        <DateInviteCard>
          ...
          <div className="mb-6 text-left">
            <h1 className="font-serif text-2xl sm:text-3xl text-dark mb-2 leading-snug font-normal text-balance">
              First things first...{' '}
              <span className="font-serif italic text-primary">who are we planning this for?</span>&nbsp;✨
            </h1>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3.5 rounded-2xl border text-dark bg-sand-50/80 placeholder:text-muted/60 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/25 transition-all text-base min-h-[48px] shadow-inner ${
