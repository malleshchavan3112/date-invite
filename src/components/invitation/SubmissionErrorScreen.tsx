      ...
      <div className="w-full max-w-sm sm:max-w-md mx-auto relative z-10">
        <DateInviteCard>
          ...
          <div className="relative inline-flex items-center justify-center mb-5">
            <div
              className="w-20 h-20 rounded-full bg-sand-100/80 border border-primary/25 flex items-center justify-center relative shadow-sm"
              aria-hidden="true"
            >
              ...
              >
                {isAlreadySubmitted ? '💌' : '✉️'}
              </motion.div>

              {/* Warning badge */}
              {!isAlreadySubmitted && (
                <span
                  className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-amber-100 text-amber-700 font-bold flex items-center justify-center text-xs shadow-xs border-2 border-white select-none"
                  aria-hidden="true"
                >
                  !
                </span>
          ...
          <FadeIn delay={0.15}>
            ...
            >
              {isAlreadySubmitted ? 'Already Submitted' : 'Something went a little sideways'}
            </h1>
          </FadeIn>
          ...
          <FadeIn delay={0.25}>
            <p className="font-sans text-sm sm:text-base text-muted-foreground mb-4 leading-relaxed max-w-xs mx-auto text-balance">
              {isAlreadySubmitted
                ...
                : "We couldn't send your response just yet. Don't worry — all your answers are safely saved."}
            </p>
          </FadeIn>
          ...
          {!isAlreadySubmitted && (
            <FadeIn delay={0.32}>
              <div className="inline-flex items-center gap-2 bg-primary-subtle border border-primary/20 rounded-full px-4 py-1.5 mb-6 text-xs font-medium text-dark shadow-2xs">
