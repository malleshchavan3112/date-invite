      ...
      <div className="w-full max-w-md mx-auto">
        <FadeIn delay={0.05}>
          <div className="content-card text-center bg-surface rounded-3xl p-6 sm:p-8 shadow-card border border-border">
            ...
            {/* Supporting Copy */}
            <FadeIn delay={0.25}>
              <p className="font-sans text-body-md text-muted mb-4 leading-relaxed max-w-xs mx-auto text-balance">
                {isAlreadySubmitted
            ...
            {!isAlreadySubmitted && (
              <FadeIn delay={0.32}>
                <div className="inline-flex items-center gap-2 bg-soft-pink/60 border border-primary/20 rounded-full px-4 py-1.5 mb-6 text-xs font-medium text-dark">
